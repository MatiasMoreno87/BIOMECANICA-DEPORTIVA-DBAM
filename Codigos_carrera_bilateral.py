...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  8 13:01:22 2024
...
cine = pd.read_csv('Cine_Annie.csv', skiprows=4) #cambiar Cine_postfatiga
cinef_= cine.iloc[:,2::].values

ev = pd.read_csv('Ev_Annie.csv', skiprows=2) # cambiar Ev_postfatiga
...
for o in range(0,24):
    ...
    for i in range(0,10): 
        ...
        #datos_R.append(cut)
        ciclosR.append(spm1d.util.interp(cut, Q=101))
        print("\n cut:")
        print(cut)
...
for r in range(0,24):
    ...
    for t in range(0,10): 
        ...
        #datos_L.append(cut1)
        ciclosL.append(spm1d.util.interp(cut1, Q=101))
...
# Se convirtió a np.array los ciclosL y ciclosR
f1= np.array(ciclosL)[30:120,:] # izquierda
f2= np.array(ciclosR)[150:240,:] # derecha
